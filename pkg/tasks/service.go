...
var svcEnvHelp = map[string]string{
	"VERIFIER_USERNAME":   "The service username for SGX APP VERIFIER configured in AAS for non stand alone mode",
	"VERIFIER_PASSWORD":   "The service password for SGX APP VERIFIER configured in AAS for non stand alone mode",
	"AAS_BASE_URL":        "The url for AAS",
	"CMS_BASE_URL":        "The url for CMS",
