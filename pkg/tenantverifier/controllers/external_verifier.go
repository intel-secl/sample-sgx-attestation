...
func (ev ExternalVerifier) VerifyQuote(quote string, key string) (QuoteVerifyAttributes, error) {
	defaultLog.Printf("in Nonstandalone VerifyQuote ")
	...
	if err != nil {
		return QuoteVerifyAttributes{}, errors.Wrap(err, "controllers/external_verifier:VerifyQuote() Error in retrieving CA certificates")
	}
	...
	if err != nil {
		return QuoteVerifyAttributes{}, errors.Wrap(err, "controllers/external_verifier:VerifyQuote() Error in sending request")
	}
